...
int main(int argc,char** argv){
    ...
    zpkg::OptionParser option_parser("g7221 convert argument:");
    auto option_help = option_parser.add<zpkg::Switch>("h","help","print g7221 help");
    auto option_file = option_parser.add<zpkg::Value<std::string>>("i","input","input ");
    auto option_simd = option_parser.add<zpkg::Switch>("s","simd","use simd version");
