...
int main(int argc,char** argv){
    ...
    zpkg::OptionParser option_parser("g711 convert argument:");
    auto option_help = option_parser.add<zpkg::Switch>("h","help","print socketproxy help");
    auto option_file = option_parser.add<zpkg::Value<std::string>>("i","input","input ");
    auto option_g711_format = option_parser.add<zpkg::Implicit<std::string>>("f","format","default format is alaw,another is mulaw","alaw");
